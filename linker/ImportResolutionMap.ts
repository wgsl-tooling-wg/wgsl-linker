import { ExportElem, TreeImportElem } from "./AbstractElems.ts";
import {
  ImportTree,
  PathSegment,
  SegmentList,
...
import { exportName, ParsedRegistry } from "./ParsedRegistry.ts";
...
class ImportToExportPath {
  constructor(public importPath: string[], public exportPath: string) {}
}
